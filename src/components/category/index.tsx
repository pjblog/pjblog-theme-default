...
import { createArticlesQuery, ICategory, useCategories } from '@pjblog/hooks';
...
export function Categories() {
  ...
  return <Flex className={styles.category} align="right">
    <Space size={16}>
    {data.map(nav => <Category {...nav} key={nav.id} />)}
    </Space>
  </Flex>
}
